        ...
        for (var _iterator5 = gameObj.flyingMissilesMap[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
          ...
          if (_distanceObj.distanceX <= gameObj.raderCanvasWidth / 2 + 50 && _distanceObj.distanceY <= gameObj.raderCanvasHeight / 2 + 50) {
            if (flyingMissile.emitPlayerId === gameObj.myPlayerObj.playerId) {
              ...
              gameObj.ctxRader.fillStyle = 'rgba(255, 0, 0, ' + _toumeido + ')';
              gameObj.ctxRader.beginPath();
              ...
              gameObj.ctxRader.strokeStyle = 'rgba(250, 250, 250, ' + _toumeido + ')';
              gameObj.ctxRader.fillStyle = 'rgba(250, 250, 250, ' + _toumeido + ')';
              gameObj.ctxRader.beginPath();
              gameObj.ctxRader.moveTo(_distanceObj.drawX, _distanceObj.drawY);
  ...
  try {
    for (var _iterator3 = gameObj.itemsMap[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
      ...
      if (distanceObj.distanceX <= gameObj.raderCanvasWidth / 2 && distanceObj.distanceY <= gameObj.raderCanvasHeight / 2) {
        ...
        gameObj.ctxRader.fillStyle = 'rgba(255, 165, 0, ' + _toumeido2 + ')';
        gameObj.ctxRader.beginPath();
  ...
  try {
    for (var _iterator4 = gameObj.airMap[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
      ...
      if (distanceObj.distanceX <= gameObj.raderCanvasWidth / 2 && distanceObj.distanceY <= gameObj.raderCanvasHeight / 2) {
        ...
        gameObj.ctxRader.fillStyle = 'rgb(0, 220, 255, ' + _toumeido3 + ')';
        gameObj.ctxRader.beginPath();
